...
export function AdminDashboard() {
  ...
  return (
    <section className="wrap admin-shell">
      ...
      <div className="security-note"><strong>Deployment checkpoint</strong><p>Protect <code>/admin*</code> and <code>/api/admin*</code> with Cloudflare Access before sharing the site. The production API also checks the administrator email allowlist.</p></div>
