  ...
  return (
    <section className="wrap admin-shell">
      <div className="admin-heading">
        <div><div className="eyebrow"><span />{data.portalOwner ? "Portal Admin" : "Administrator"}</div><h1>Collection Verification</h1><p>Review resident and outside-vendor donations, payment proofs and verified festival collections.</p></div>
      ...
      <div className="admin-metrics">
        ...
        <article><span>Donation submissions</span><strong>{data.totals.submissions}</strong></article>
      </div>
