...
export const POOJA_REGISTRATION_TYPES = [
  "daily",
  "saraswathi",
  // "lakshmi", // Temporarily closed for new registrations. Retain its type and label for existing records.
  "homam",
] as const satisfies readonly PoojaType[];
...
export function poojaDate(type:PoojaType){return type==="saraswathi"?"2026-09-16":type==="lakshmi"?"2026-09-18":type==="homam"?"2026-09-20":"";}
