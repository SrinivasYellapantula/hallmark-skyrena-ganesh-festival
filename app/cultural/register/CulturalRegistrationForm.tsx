...
export function CulturalRegistrationForm({editToken="",editId=""}:{editToken?:string;editId?:string}) {
  ...
  async function submit(event:FormEvent<HTMLFormElement>){
    ...
    const body=new FormData(event.currentTarget);body.set("performanceType",performanceType);body.set("audioArrangement",audioArrangement);body.set("participantDetails",JSON.stringify(participants));if(editToken)body.set("editToken",editToken);if(editId)body.set("id",editId);
